    ...
    <div class="timeline">
      ...
      <div class="container left">
        <div class="content" v-scrollanimation>
          ...
          <div class="bodyContent">
            <img src="@/assets/img/UnivalleLogo.png" width="170" />
            <p v-scrollanimation>
              <br />
              <br />Licenciatura en Ingeniería de Sistemas Informáticos
            </p>
          </div>
        </div>
      </div>
